...
# print(get_info_this_week("Репетиционная комната №4", 'понедельник'))
# print(get_info_this_week('Репетиционная комната №4', 'пятница'))
# print(get_info_next_week('Репетиционная комната №4', 'понедельник'))
